...
Stack: [PyTorch](https://pytorch.org), [NVIDIA](https://www.nvidia.com), [Cursor](https://cursor.com), [Grok](https://grok.com).
...
| [dgx-lab](https://github.com/jxtngx/dgx-lab) | NVIDIA DGX Spark, local-first |
